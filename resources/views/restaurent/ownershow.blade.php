...
@endif
  <div class="card">
    <div class="card-header">
      <div class="row">
        {{-- <div class="col-md-1">
            <form method="post" action="/restaurent/owner/5">
                @csrf
                @method('delete')
                <input type="submit" onclick="return confirm('Are you sure, you want to delete this restaurent?')" class="btn btn-danger" value="Delete"/>
            </form>
        </div> --}}
        <div class="col-md-1">
        <form method="get" action="/restaurent/owner/{{$restaurent->id}}/edit">
