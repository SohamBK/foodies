...
class ReceivePaymentProvider extends PaytmWalletProvider{
	...
	private function beginTransaction(){
		$params = [
			...
			'MID' => 'xDXBgS57377830380708',//$this->merchant_id,
			'ORDER_ID' => $this->parameters['order'],
			'CUST_ID' => $this->parameters['user'],
			'INDUSTRY_TYPE_ID' => 'Retail',//$this->industry_type,
			'CHANNEL_ID' => 'WEB ',//$this->channel,
			'TXN_AMOUNT' => $this->parameters['amount'],
			'WEBSITE' => 'WEBSTAGING ',//$this->merchant_website,
